package Sethy.SethyProjectBackend.config;
...
public class JwtTokenManager {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        if (roles.contains(new SimpleGrantedAuthority("PHARMACIST_USER"))) {
    ...
    public List<SimpleGrantedAuthority> getRolesFromToken(String token) {
        ...
        Boolean isUser = claims.get("isPharmacist", Boolean.class);
        ...
        if (isUser != null && isUser) {
            roles.add(new SimpleGrantedAuthority("PHARMACIST_USER"));
        }
        return roles;
